...
public class AIControl : MonoBehaviour {
	...
	public static string[]SnakeName = new string[]{"AI1Panduan","AI2Panduan","AI3Panduan","AI4Panduan","AI5Panduan","AI6Panduan","AI7Panduan","AI8Panduan","AI9Panduan","AI10Panduan","","","","","","","","","","",};
...
//		int length = pos [0, 0].SnakeLength;
	...
	public void flootAIOneBody(Vector3 V){//v移动前坐标 c1 蛇头名字 s1 找到要添加的AI1
