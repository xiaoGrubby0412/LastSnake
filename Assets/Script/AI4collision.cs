...
public class AI4collision : MonoBehaviour {


	AIRandom ai = new AIRandom ();
	AIControl add = new AIControl ();
	public void OnTriggerEnter(Collider collider){
		AIRoot4 (collider.name,3,3);
		
	}
	//public static string []str4 =new string[10]{"body","AIon","AIni","AIth","AItw","AIfi","AIsi","Aise","AIei","AIte"}; 
	public void AIRoot4(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str4.GetLength(0)-1;i++)
		if(sssss==One.str4[i]){
