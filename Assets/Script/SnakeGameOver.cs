...
public class SnakeGameOver : MonoBehaviour
{
    ...
    private static string[] str = new string[14]
    {
        "yaogangfather", "yanggangsun", "lenthandkill", "lengthshare", "killCount", "snakeTiShi", "panhang",
        "jinrizuijia", "yongdao", "jiasudu", "timel", "dierming", "disangming", "disiming"
    };

    //游戏模式跳转到无尽模式需要隐藏的对象
    public void YINCanGobject(int dep)
    {
        //一个参数depth
//		print (dep);
        //把摇杆先隐藏起来
