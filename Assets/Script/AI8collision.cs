...
public class AI8collision : MonoBehaviour {
	
	AIRandom ai = new AIRandom ();
	AIControl add = new AIControl ();
	public void OnTriggerEnter(Collider collider){
		AIRoot8 (collider.name,7,7);
		
	}
	//public static string []str8 =new string[10]{"body","AIon","AIni","AIth","AIfo","AIfi","AIsi","Aise","AItw","AIte"}; 
	public void AIRoot8(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str8.GetLength(0)-1;i++)
		if(sssss==One.str8[i]){
