...
//		print (spr.width + ",." + spr.height);
    ...
    //所有颜色的食物
    public static string[] Food = new string[14]
    {
        "zxf", "node01", "node02", "node03", "node04", "node05", "node06", "node07", "node08", "node09", "node10",
    ...
    public void SnakeBody(string s)
    {
        //蛇的身体
    ...
    //AI1
    //AIone
    public void AIOneBody(string s, string sname, int bi, string fd, string bodyname)
    {
        //创建AI蛇的身体
...
//			int a = obj.transform.childCount;
    ...
    //商城所有能买的虫的图片大小
    public static string[] sizeSD = new string[9]
    {
        "zhongguo", "zhongguoxianggang", "qingse", "jianada", "agengting", "dahong", "xiaolan", "xiaolv", "xiaohuang"
    };
