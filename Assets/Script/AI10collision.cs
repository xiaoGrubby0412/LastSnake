...
public class AI10collision : MonoBehaviour {
...
//	One yes = new One ();
	public void OnTriggerEnter(Collider collider){
		AIRoot10 (collider.name,9,9);
		
	}
	//public static string []str10 =new string[10]{"body","AIon","AIni","AIth","AIfo","AIfi","AIsi","Aise","AIei","AItw"}; 
	public void AIRoot10(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str10.GetLength(0)-1;i++)
		if(sssss==One.str10[i]){
