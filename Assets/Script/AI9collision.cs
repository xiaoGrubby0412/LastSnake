...
public class AI9collision : MonoBehaviour {
	...
	public void OnTriggerEnter(Collider collider){
		AIRoot9 (collider.name,8,8);
		
	}
	//public static string []str9 =new string[10]{"body","AIon","AItw","AIth","AIfo","AIfi","AIsi","Aise","AIei","AIte"}; 
	public void AIRoot9(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str9.GetLength(0)-1;i++)
		if(sssss==One.str9[i]){
