...
public class AI6collision : MonoBehaviour {
	...
	public void OnTriggerEnter(Collider collider){
		AIRoot6 (collider.name,5,5);
		
	}
	//public static string []str6 =new string[10]{"body","AIon","AIni","AIth","AIfo","AIfi","AItw","Aise","AIei","AIte"}; 
	public void AIRoot6(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str6.GetLength(0)-1;i++)
		if(sssss==One.str6[i]){
