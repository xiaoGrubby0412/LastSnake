...
public class AI7collision : MonoBehaviour {

	AIRandom ai = new AIRandom ();
	AIControl add = new AIControl ();

	public void OnTriggerEnter(Collider collider){
		AIRoot7 (collider.name,6,6);
		
	}
	//public static string []str7 =new string[10]{"body","AIon","AIni","AIth","AIfo","AIfi","AIsi","Aitw","AIei","AIte"}; 
	public void AIRoot7(string str,int xiabiaozhi,int cou){//一个是碰撞到的名字，一个是他所处的下标，一个是判断碰撞到不能碰撞的东西
		string ss=str;
		...
		for(int i=0;i<One.str7.GetLength(0)-1;i++)
		if(sssss==One.str7[i]){
